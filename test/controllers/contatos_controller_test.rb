...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { email: @contato.email, nome: @contato.nome, participante_id: @contato.participante_id, setor_id: @contato.setor_id, tel: @contato.tel }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { email: @contato.email, nome: @contato.nome, participante_id: @contato.participante_id, setor_id: @contato.setor_id, tel: @contato.tel }
    assert_redirected_to contato_path(assigns(:contato))
  end
