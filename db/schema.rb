...
ActiveRecord::Schema.define(version: 20140805225430) do
  ...
  create_table "participantes", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "transportadora",      limit: 1
    t.string   "fantasia",            limit: 60
    t.string   "site"
    t.string   "optante_simples",     limit: 1
    t.date     "data_relacao"
    t.string   "inativo",             limit: 1
    t.string   "obs_relacoes",        limit: 150
    t.string   "indicado_por",        limit: 40
    t.string   "observacao",          limit: 150
    t.string   "complemento",         limit: 60
    t.string   "complemento_cob",     limit: 60
    t.string   "complemento_entrega", limit: 60
    t.string   "obs_ender",           limit: 150
    t.string   "obs_ender_cob",       limit: 150
    t.string   "obs_ender_entrega",   limit: 150
  end
