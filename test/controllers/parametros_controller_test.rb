...
class ParametrosControllerTest < ActionController::TestCase
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post :create, parametro: { cnpj: @parametro.cnpj, imposto: @parametro.imposto, razao_social: @parametro.razao_social }
    end
  ...
  test "should update parametro" do
    patch :update, id: @parametro, parametro: { cnpj: @parametro.cnpj, imposto: @parametro.imposto, razao_social: @parametro.razao_social }
    assert_redirected_to parametro_path(assigns(:parametro))
  end
